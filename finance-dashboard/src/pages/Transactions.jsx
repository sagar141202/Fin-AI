...
import { Search, Filter, Trash2, Plus, ArrowUp, ArrowDown, AlertTriangle } from "lucide-react"
            ...
            <thead>
              <tr className="border-b border-gray-800">
                <th
                  ...
                  className="text-left px-6 py-4 text-gray-400 text-sm font-medium cursor-pointer hover:text-white"
                >
                ...
                <th
                  ...
                  className="text-right px-6 py-4 text-gray-400 text-sm font-medium cursor-pointer hover:text-white"
                >
                ...
                sorted.map(tx => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      {tx.description && (
                        <div className="text-gray-500 text-xs mt-0.5">{tx.description}</div>
                      )}
                    </td>
                    <td className="px-6 py-4">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-800">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={page === 1}
                className="px-3 py-1 bg-gray-800 text-gray-300 rounded-lg text-sm disabled:opacity-40 hover:bg-gray-700 transition-colors"
              >
                Previous
              </button>
              <button
